 ...
 * related to the Brighness and Contrast settings of displayed images. It also displays a histogram of pixel values for
 * specific images and also contains elements for controling which LUT is being used by the plugin.
 *
 * @author zkaufman
 */

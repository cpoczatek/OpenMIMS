...
public abstract class SegmentationEngine extends SwingWorker<Boolean, Void> {
    ...
    public static final String ENGINE = "engine", // name of the segmentation engine class (e.g. lib-SVM)
    ...
    /**
     * This method is called automatically before the engine is executed and is supposed to check on the parameters in
     * the properties object. Default values should be set here, if necessary.
     *

...
//        loadPredictionButton.setEnabled(!working);
    ...
    private void initComponents() {
        ...
        predictionPanelLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, predictionPanelLayout.createSequentialGroup()
                ...
                .addGroup(predictionPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(classesCombo, 0, 285, Short.MAX_VALUE)
                    ...
                    .addGroup(predictionPanelLayout.createSequentialGroup()
                        .addGroup(predictionPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(savePredictionButton, javax.swing.GroupLayout.DEFAULT_SIZE, 205, Short.MAX_VALUE)
                            .addComponent(loadPredictionButton, javax.swing.GroupLayout.DEFAULT_SIZE, 205, Short.MAX_VALUE))
                        .addGap(26, 26, 26)
        ...
        jButton1.setText("Validate(For Testing only)");
        jButton1.setActionCommand("Validate(For testing)");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(6, 6, 6)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(workLabel, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 319, Short.MAX_VALUE)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addComponent(progressBar, javax.swing.GroupLayout.DEFAULT_SIZE, 234, Short.MAX_VALUE)
                        .addGap(85, 85, 85))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(predictionPanel, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
...
//        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        segUtil = SegUtils.initPrepSeg(images, colorImageIndex, localFeatures, trainClasses);
        segUtil.prepareSegmentation();
        double[] stes={0.01,0.05,0.1,0.15,0.2,0.25,0.4,0.5,0.6,0.75,0.8};

        ArrayList<ArrayList<ArrayList<Double>>> segData = segUtil.getData();
        SvmTools.doubleCV(stes, segData, properties,"/home/gormanns/Harvard/doubleCV/"+mimsUi.getImageFilePrefix()); //hier kommt am Ende das Ergebnis raus
        //Pass the output directory here as an argument

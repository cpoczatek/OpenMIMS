...
/**
 * The MimsHSIView class creates the "Process" tab on the main UI window. It
 * contains all the functionality for generating and displaying HSI and ratio
 * images. Sliding windows as well as a mendian filter can be applied via this
 * class.
 *
 * @author zkaufman
 */
public class MimsHSIView extends javax.swing.JPanel {
    ...
    /**
     * To be called whenever a change is made that requires updating to the HSI
     * image. For example: a change in the rgb slider, threshold, etc.
     */
    ...
    /**
     * Determine if a pair of masses are an isotopic pair TODO: Currently this
     * is checking that the last element in ions match. This is a false positive
     * for things like oxides, eg FO/SnO would appear.
     *
     * @param num
     * @param den
     * @return
    ...
    /**
     * Sets all the relevant sliders and spinner to reflect the values contained
     * in the
    ...
    /**
     * Sets all the relevant spinners to reflect the values contained in the
     * <code>props</code> object.
     *
     * @param props the props object.
     */
    ...
    /**
     * Sets the current image, which in turn, sets which parameters that can and
     * can not be adjusted. This method should probably be expanded to include a
     * call to
     * <code>setProps</code>.
     *
     * @param mp the image.
    ...
    /**
     * Returns
     * <code>true</code> if the "median filter ratio" radio button is selected.
     *
     * @return <code>true</code> if the "median filter ratio" radio button is
    ...
    /**
     * Returns
     * <code>true</code> if the "Use Sum" radio button is selected.
     *
     * @return <code>true</code> if the "Use Sum" radio button is selected,
    ...
    /**
     * Sets the "Use Sum" radio button to
     * <code>bool</code>.
     */
    ...
    /**
     * Sets the "Use Window" radio button to
     * <code>bool</code>.
     */
    ...
    /**
     * A custom renderer class that controls the way the list displays potential
    ...
    /**
     * Generate a small popup window that allows the user to add any possible
     * ratio image to the list that may not already be there by default.
     */

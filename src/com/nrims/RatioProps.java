...
/**
 * The RatioProps class is required to generate a ratio
 * image and it also serves to store values related to
 * how the image displayed. This class can be written to
...
public class RatioProps implements java.io.Serializable {
   ...
   /**
    * Sets the minimum value of the LUT. Used for contrasting
    * purposes.
    *
   ...
   /**
    * Gets the minimum value of the LUT. Used for contrasting
    * purposes.
    *
    * @return double
    */
   ...
   /**
    * Sets the maximum value of the LUT. Used for contrasting
    * purposes.
    *
   ...
   /**
    * Gets the maximum value of the LUT. Used for contrasting
    * purposes.
    *
    * @return double
    */
